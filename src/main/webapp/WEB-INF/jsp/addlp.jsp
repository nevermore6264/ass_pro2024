...
<div>
	   ...
	   <div class="form-group">
		...
		<div class="col-sm-10">
			<frm:input id="tenLoaiPhong" class="form-control" path="tenLoaiPhong" placeholder="Nhập tên loại phòng" />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<frm:input id="moTa" class="form-control" path="moTa" placeholder="Nhập mô tả" />
		</div>
	</div>
