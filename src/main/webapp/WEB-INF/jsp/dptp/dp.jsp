...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
      ...
      <div class="container" style="height: 600px;margin-top: 15px">
            ...
            <tr>
            <th>Loại phòng</th>
            <td><c:if test="${thongtinphong.loaiPhong.tenLoaiPhong=='VIP'}"><img src="hinh/vip.png" width="55px" height="23px" style="margin-bottom: 5px;-webkit-filter: drop-shadow(1px 1px 1px #888888); filter: drop-shadow(1px 1px 1px #888888);"></img></c:if><c:if test="${thongtinphong.loaiPhong.tenLoaiPhong=='Thường'}">Thường</c:if></td>
            </tr>
         ...
         <frm:hidden path="taiKhoan.tenDangNhap" value="${nguoidung }"/>
         
         <div class="form-group">
		<label for="hoTen" style="font-weight: bold;">Họ tên khách hàng:</label>
		
			<frm:input id="hoTen" class="form-control" path="hoTen" placeholder="Nhập họ và tên" required="required"/>
		...
		<label for="soDT" style="font-weight: bold;">Số điện thoại:</label>
			...
			<frm:input id="soDT" type="number" class="form-control" path="soDT" placeholder="Nhập số điện thoại" min="999999" max="99999999999999" required="required"/>
		...
		<label for="soCMND" style="font-weight: bold;">Số chứng minh:</label>
			...
			<frm:input id="soCMND" type="number" class="form-control" path="soCMND" placeholder="Nhập số chứng minh" required="required"/>
		...
		<label for="tienCoc" style="font-weight: bold;">Tiền cọc:</label>
			...
			<frm:input id="tienCoc" type="number" class="form-control" path="tienCoc" placeholder="Nhập tiền cọc" required="required"/>
		...
		<label for="ngayDat" style="font-weight: bold;">Ngày đặt:</label>
			...
			<frm:input id="ngayDat" class="form-control" path="ngayDat" type="date" value="${ngayhientai }" required="required"/>
...
#myImg${thongtinphong.maPhong}:hover {opacity: 0.7;}
...
.close${thongtinphong.maPhong}:hover,
.close${thongtinphong.maPhong}:focus {
    color: #bbb;
...
<div id="myModal${thongtinphong.maPhong}" class="modal${thongtinphong.maPhong}">
  <span class="close${thongtinphong.maPhong}">&times;</span>
  <img class="modal${thongtinphong.maPhong}-content" id="${thongtinphong.maPhong}">
...
var captionText = document.getElementById("caption${thongtinphong.maPhong}");
