...
<div>
	   ...
	   <div class="form-group">
		<label for="matkhaucu" style="font-weight: bold;">Mật khẩu cũ:</label>
		<div class="col-sm-10">
			<input type="password" name="matkhaucu" id="matkhaucu" class="form-control" placeholder="Nhập mật khẩu cũ" required="required">
		</div>
	</div>
	...
	<div class="form-group">
		<label for="matkhaumoi" style="font-weight: bold;">Mật khẩu mới:</label>
		<div class="col-sm-10">
			<input type="password" name="matkhaumoi" id="matkhaumoi" class="form-control" placeholder="Nhập mật khẩu mới" required="required" >
		</div>
	</div>
	  
             <div class="form-group">
		<label for="xacnhanmatkhaumoi" style="font-weight: bold;">Xác nhận mật khẩu mới:</label>
		<div class="col-sm-10">
			<frm:input path="matKhau" type="password"  class="form-control" placeholder="Xác nhận mật khẩu mới" required="required" ></frm:input>
		</div>
	</div>
           
         <div class="container">
			<button type="submit" class="btn btn-success btn-xs">Hoàn tất</button>
		</div>
